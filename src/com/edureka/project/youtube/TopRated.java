...
public class TopRated {
	...
	// total rating is rating x rating count
	@Override
		...
		Long ratingCount = Long.parseLong(str[Utils.YOUTUBE_RATING_COUNT]);
		Double totalRating = rating * ratingCount;
		context.write(new DoubleWritable(totalRating), new Text(vdoId));
            }
            catch(Exception e)
            {
